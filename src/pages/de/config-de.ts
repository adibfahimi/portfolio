...
export const ConfigDE: IConfig = {
  ...
  projects: {
    ...
    "PixelPay": {
      ...
      description: "Ein Blockchain-Projekt mit Node, Wallet und Miner, erstellt mit Go und gRPC.",
      tags: ["Golang", "Blockchain", "gRPC", "Protocol Buffers"],
    },
    MNIST: {
      url: "https://github.com/adibfahimi/mnist",
      description: "Erkennung handschriftlicher Ziffern mithilfe des MNIST-Datensatzes.",
